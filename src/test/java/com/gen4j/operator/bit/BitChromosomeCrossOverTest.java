...
@PrepareForTest({ BitChromosomeCrossOver.class, BitChromosome.class })
public class BitChromosomeCrossOverTest {
    ...
    @TestSubject
    private BitChromosomeCrossOver subject;

    @Before
    public void setUp() throws IllegalAccessException {
        subject = new BitChromosomeCrossOver();
        MemberMatcher.field(BitChromosomeCrossOver.class, "random").set(subject, random);
    }
